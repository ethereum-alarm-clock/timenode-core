...
var TimeNode = /** @class */ (function () {
    ...
    TimeNode.prototype.startupMessage = function () {
        ...
        this.config.logger.info('Version: ' + version_1.default);
    };
    TimeNode.prototype.logNetwork = function () {
        var _this = this;
        this.config.web3.version.getNetwork(function (e, r) {
            if (e) {
                throw new Error(e);
            }
            else {
                _this.config.logger.info('Operating on ' + network_1.default[r]);
            }
        });
    };
    TimeNode.prototype.startScanning = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.scanner.start()];
            });
        });
    };
    TimeNode.prototype.stopScanning = function () {
