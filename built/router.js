...
var Status;
(function (Status) {
    Status[Status["BeforeClaimWindow"] = 0] = "BeforeClaimWindow";
    Status[Status["ClaimWindow"] = 1] = "ClaimWindow";
    Status[Status["FreezePeriod"] = 2] = "FreezePeriod";
    Status[Status["ExecutionWindow"] = 3] = "ExecutionWindow";
    Status[Status["Executed"] = 4] = "Executed";
                ...
                switch (_a.label) {
                    case 0:
                        if (txRequest.isCancelled) {
                            // TODO Status.CleanUp?
                            return [2 /*return*/, Status.Executed];
                        }
                        return [4 /*yield*/, txRequest.beforeClaimWindow()];
                    case 1:
                        if (_a.sent()) {
                            return [2 /*return*/, Status.BeforeClaimWindow];
                        }
                        return [2 /*return*/, Status.ClaimWindow];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (txRequest.isClaimed) {
                            return [2 /*return*/, Status.FreezePeriod];
                        }
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        ...
                        throw new Error(e_1);
                    case 4: return [2 /*return*/, Status.FreezePeriod];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        if (_a.sent()) {
                            return [2 /*return*/, Status.ExecutionWindow];
                        }
                        return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        //TODO handle gracefully?
                        throw new Error(e_2);
                    case 5: return [2 /*return*/, Status.Executed];
                }
            });
        });
    };
    ...
    Router.prototype.route = function (txRequest) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        status = this.txRequestStates[txRequest.address] || Status.BeforeClaimWindow;
