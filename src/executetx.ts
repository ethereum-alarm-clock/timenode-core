...
function calcEndowment(gasAmount = 0, amountToSend = 0, gasPrice = 0, fee = 0, payment = 0) {
...
const main = async () => {
    ...
    const getBlockNumber = () => Bb.fromCallback(callback => web3.eth.getBlockNumber(callback));
    ...
    const customProviderUrl = 'wss://rarely-suitable-shark.quiknode.io/87817da9-942d-4275-98c0-4176eee51e1a/aB5gwSfQdN4jmkS65F1HyA==/';
